...
def find_string_cost(temp_string):
    summ = 0
    temp_string = temp_string.upper()
    for i in temp_string:
        summ += int(dictinory_simbols.get(i))

    return summ

dictinory_simbols = {'A':'1','E':'1','I':'1','O':'1','U':'1','L':'1','N':'1','S':'1','T':'1','R':'1','D':'2','G':'2',
...
user_string = input("Введите слово или строку: ")

print(find_string_cost(user_string))
